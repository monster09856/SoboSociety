...
import { api, MemberSummaryResponse, ApiError } from '@/lib/api'
...
export default function HesabimPage() {
  ...
  const fetchSummary = async () => {
    ...
    try {
      const data = await api.my.getSummary()
      setSummary(data)
    } catch (err) {
  ...
  // Brand Status Badges (attended = Adaçayı Yeşil, no_show = Kiremit Kırmızı, booked = Espresso, cancelled = Gri)
